...
## Get effort and number of HI_type dolphins
...
## Create a Function to Count the Number of Individuals in Disignated Time Resolution

```{r func, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r scale, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r WDI, echo=TRUE, message=FALSE, warning=FALSE}
